...
import OrganizationRegistrationForm from '@/features/registration/components/OrganizationRegistrationForm.jsx'

function OrganizationRegistrationPage() {
  return (
    <section className="max-w-4xl" aria-labelledby="organization-registration-title">
      <Button
        className="mb-8 px-0"
        nativeButton={false}
      ...
      <h1
        ...
        id="organization-registration-title"
      >
        Organization registration request
      </h1>
      <p className="mt-5 max-w-2xl text-lg leading-8 text-slate-600">
        Provide the organization and contact details for frontend validation. This form is not
