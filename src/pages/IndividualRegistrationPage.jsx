...
import IndividualRegistrationForm from '@/features/registration/components/IndividualRegistrationForm.jsx'

function IndividualRegistrationPage() {
  return (
    <section className="max-w-2xl" aria-labelledby="individual-registration-title">
      <Button
        className="mb-8 px-0"
        nativeButton={false}
      ...
      <p className="mt-5 text-lg leading-8 text-slate-600">
        Provide your details for frontend validation. This form is not connected to backend
        submission yet.
      </p>
